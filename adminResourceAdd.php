...
if(
    ...
    <html lang="en">
        <head>
            ...
            <title>Admin Add Resources</title>
        </head>
        <body>   
            <!--navigation section-->
            <section id="#navbar">
            ...
            <h1 class="title" style="text-align: center; background-color: #211A1E; color: #84B082;"> Add Resources and Information </h1><br>
            <div class="container">
                <form action="adminResourceAddProcess.php" method='POST' enctype="multipart/form-data">
                    <!-- categoryName -->
                    ...
                    <!-- about -->
                    <div class="row form-group form-floating">
                        <textarea class="form-control" placeholder="Description" id="about" name="about" style="height:200px; width=100%; font-size:14pt;"></textarea>
                        <label for="about"> &nbsp; Description</label>
                    </div><br>
                    <!-- nextExamDate-->
                    <div class="row">
                        <div class="col-lg-6 form-group form-floating">
                            <input type="date" class="form-control" placeholder="Next Exam Date" aria-label="Next Exam Date" id="nextExamDate" name="nextExamDate">
                            <label for="nextExamDate"> &nbsp; Next Exam Date </label>
                        </div>
                    </div><br>
                    <!-- introVedioLink -->
                    <div class="row form-group form-floating">
                        <input type="text" class="form-control" placeholder="Intro Vedio Link"  id="introVedioLink" name="introVedioLink">
                        <label for="introVedioLink"> &nbsp; Intro Vedio Link</label>
                    </div><br>
                    <!-- officialWebsiteLink -->
                    <div class="row form-group form-floating">
                        <input type="text" class="form-control" placeholder="Official Website Link"  id="officialWebsiteLink" name="officialWebsiteLink">
                        <label for="officialWebsiteLink"> &nbsp; Official Website Link</label>
                    </div><br>
                    <!-- gDriveLink -->
                    <div class="row form-group form-floating">
                        <input type="text" class="form-control" placeholder="Google Drive Link"  id="gDriveLink" name="gDriveLink">
                        <label for="gDriveLink"> &nbsp; Google Drive Link</label>
                    </div><br>
                    
                    <!-- moreLink -->
                    <div class="row form-group form-floating">
                        <input type="text" class="form-control" placeholder="More Resource Link"  id="moreLink" name="moreLink">
                        <label for="moreLink"> &nbsp; More Resource Link</label>
                    </div><br>

                    <!-- pdf -->
                    <div>
                        <label for="uploadPDF">Upload PDF File:</label>
                        <input type="file" id="pdf" name="pdf" style="border: none;">
                    </div><br>

                    <!-- image -->
                    <div>
                        <label for="uploadImage">Upload Image File:</label>
                        <input type="file" id="image" name="image" style="border: none;">
                    </div><br><br>
                    <input type="submit" value="ADD Resource" class="btn btn-lg" style="background-color: royalblue; color: white"></input>
                </form><br>
            </div>
            </section><br>
            <!-- Ending  -->

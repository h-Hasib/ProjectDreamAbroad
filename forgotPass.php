        ...
        <div class="container regForm">
            ...
            <form action="/newaccount" method=post oninput='up2.setCustomValidity(up2.value != up.value ? "Passwords do not match." : "")'>
                <div class="form-group form-floating">
                    <input type="email" class="form-control bright" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Email" id="floatingInput">
                    <label for="floatingInput">Email address</label>
                </div><br>
                <div class="row">
                </div><br>

                <button type="submit" class="btn btn-lg">Send Verification</button>
            </form><br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 social">
                    <!--                   social media icons-->
                    <h2>Social Media</h2>
                    <a href="facebook.com" style="color: royalblue"><i class="fab fa-facebook-square"></i></a>
                    <a href="twitter.com" style="color: skyblue"><i class="fab fa-twitter-square"></i></a>
                    <a href="linkedin.com" style="color: royalblue;"><i class="fab fa-linkedin"></i></a>
                    <a href="youtube.com" style="color: orangered"><i class="fab fa-youtube-square"></i></a>
                </div>
            </div>
        </div>
    </section>

...
if(
    ...
    <body>
        ...
        <section id="editProfile">
          ...
          <div class="container">
              <form action="changePasswordProcess.php" method='POST'  oninput='newPass1.setCustomValidity(newPass1.value != newPass.value ? "Passwords do not match." : "")'>
                <!-- currentPass -->
                <div class="row">
                ...
                <input type="submit" value="Change Password" class="btn btn-lg" style="background-color: red; color: white"></input>
              </form><br>
          </div>
        </section><br>
